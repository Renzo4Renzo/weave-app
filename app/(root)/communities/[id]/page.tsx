    ...
    <section>
      ...
      <div className="mt-9">
        <Tabs defaultValue="wisps" className="w-full">
          ...
          <TabsContent value="wisps" className="w-full text-light-1">
            <WispsTab currentUserId={user.id} accountId={communityDetails._id} accountType="Community" />
          </TabsContent>
